...
const cap = require("capitalize-first-letter")
   ...
   run: async (client, message, args) =>{
    ...
    let confe = new Discord.MessageEmbed()
        .setDescription(`<a:SA_typing:869625185219801098> Waiting for **${user.user.username}** to accept your game of **RPS**`)
        .setColor("PURPLE"
)
    ...
    message.reply({       
        ...
        collector.on('collect', (button) => {
            ...
            let choices = new Discord.MessageActionRow()
                .addComponents(
                new Discord.MessageButton()
                .setCustomId('rock')
                .setStyle('SECONDARY')
        ...
        collector.on('end', (collected, reason) => {
            if (reason == 'time') {
                let embed = new Discord.MessageEmbed()
                    .setTitle('Command has Timed Out!')
                    .setColor("RED")
